...
def build_model(train, test, config):
	...
	model = Sequential()
	model.add(Conv1D(32, 3, input_shape=(n_timesteps, n_features)))
...
# evaluate model and get scores - try 500 epochs
# keep the same batch sizes with the higher learning rate
Model[[10, 100, 200, 16, 1, 5, 0.01, 'relu']] 1.736
Model[[10, 100, 200, 16, 1, 5, 0.05, 'relu']] 1.736
Model[[10, 100, 100, 128, 1, 5, 0.05, 'relu']] 1.736
Model[[10, 100, 100, 64, 1, 5, 0.05, 'relu']] 1.736
Model[[10, 100, 100, 32, 1, 5, 0.05, 'relu']] 1.736
Model[[10, 100, 100, 16, 1, 5, 0.01, 'relu']] 1.736
